...
export default {
  ...
  fields: {
    ...
    ref: { x: 105, y: 590, calc: (scores: Stats) => add_plus(ability_modifier(scores['agl'], 1)) },
    fort: { x: 105, y: 545, calc: (scores: Stats) => add_plus(ability_modifier(scores['sta'], 1)) },
    will: { x: 105, y: 500, calc: (scores: Stats) => add_plus(ability_modifier(scores['per'])) },
    grit: {
