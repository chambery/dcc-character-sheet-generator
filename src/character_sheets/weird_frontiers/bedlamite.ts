...
export default {
  ...
  fields: {
    ...
    ref: { x: 105, y: 595, calc: (scores: Stats) => decorate(ability_modifier(scores['agl'], 1), ['+']) },
    fort: { x: 105, y: 550, calc: (scores: Stats) => decorate(ability_modifier(scores['sta']), ['+']) },
    will: { x: 105, y: 505, calc: (scores: Stats) => decorate(ability_modifier(scores['per'], 1), ['+']) },
    grit: {
