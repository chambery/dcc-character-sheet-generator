...
export default {
    ...
    fields: {
      ...
      ref: { x: 100, y: 591, calc: (scores: Stats) => add_plus(ability_modifier(scores['agl'])) },
      ...
      hp: { x: 200, y: 630, calc: (scores: Stats) => hp(scores, '1d14'), style: { size: 14 } },
